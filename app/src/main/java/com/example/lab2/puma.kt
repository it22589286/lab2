...
class puma : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_puma)

        val nextbutton8 = findViewById<Button>(R.id.cartpuma)
        nextbutton8.setOnClickListener {
            val intent4 = Intent(this, cart::class.java)
            startActivity(intent4)
            finish()
        }
        val nextbutton3 = findViewById<FloatingActionButton>(R.id.actionpuma)
        ...
        val nextbutton9 = findViewById<Button>(R.id.pumabuy)
